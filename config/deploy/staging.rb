...
set :application, "Crime-Staging" # unique name of application
set :user, "crime-staging" # name of user on server
...
set :github_repo_name, "crime_reports" # name of git hub repo
